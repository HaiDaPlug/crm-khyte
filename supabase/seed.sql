...
insert into opportunities (id, company_id, contact_id, stage, priority, in_pipeline, deal_value, next_step, follow_up_date, last_interaction, tags, notes) values
  ...
  ('33333333-3333-4333-8333-000000000007', '11111111-1111-4111-8111-000000000001', '22222222-2222-4222-8222-000000000001', 'New',            'medium',   false,  32000, 'Draft personalized outreach email',         '2026-04-01', '2026-03-21', '{researched}',                  'Secondary opportunity at Meridian Labs for their EU expansion team.')
on conflict (id) do nothing;
