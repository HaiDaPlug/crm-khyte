...
export const mockGoals: Goal[] = [
  ...
  },
  {
    ...
    detail: '',
    status: 'on_track',
    // Deliberately left on the retired `progress` with no target: this is the
    // one goal here that was never really a count ("75% of running all of our
    // sales" is a feeling), so it demos the other half of the model — no bar,
    // and the old estimate shown in the editor as a hint until someone gives
    // it a real Nu/Mål. See lib/goal-measure.ts.
    progress: 75,
    targetDate: '2026-09-30',
    order: 5,
  },
