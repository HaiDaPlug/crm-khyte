...
const sv = {
  ...
  organization: {
    ...
    errors: {
      ...
      already_member: 'Personen är redan medlem.',
      ...
      membership_unsaved: 'Kontots lösenord byttes, men ändringen kunde inte sparas. Försök igen — ett nytt tillfälligt lösenord skapas då.',
...
const en: Dictionary = {
  ...
  organization: {
    ...
    errors: {
      ...
      membership_unsaved: 'The account password was replaced, but the change could not be saved. Try again; a new temporary password will be issued.',
