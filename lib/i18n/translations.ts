...
const sv = {
  ...
  pipeline: {
    ...
    addLeads: 'Lägg till leads',
    offBoard: 'Leads som inte finns på tavlan',
    startsNew: 'Leads som läggs till börjar i ”Ny”',
    allOnBoard: 'Alla leads finns redan på tavlan.',
  },
  strategy: {
    title: 'Strategi',
  ...
  crm: {
    ...
    companyForm: {
      title: 'Nytt företag',
      subtitle: 'Bara det viktigaste – kontakter och leads kan kopplas senare.',
    ...
    contactForm: {
      title: 'Ny kontakt',
      subtitle: 'Bara det viktigaste – koppla personen till en lead senare.',
    ...
    leadForm: {
      ...
      leaveOffBoard: 'Lämna tomt för att hålla leaden utanför tavlan',
    ...
    table: {
      ...
      followUp: 'Uppföljning',
      tags: 'Taggar',
      empty: 'Inga leads matchar de aktuella filtren.',
    },
    detail: {
...
const en: Dictionary = {
  ...
  leads: { title: 'Leads', allLeads: 'All Leads', count: (filtered, total) => `${filtered} of ${total} opportunities`, newLead: 'New Lead' },
  pipeline: {
    title: 'Pipeline', description: 'Drag cards between stages to update progress', activePipeline: 'Active Pipeline',
    addLeads: 'Add Leads', offBoard: 'Leads not on the board', startsNew: 'Added leads start in “New”',
    allOnBoard: 'Every lead is already on the board.',
  },
  strategy: {
  ...
  crm: {
    ...
    companyForm: {
      title: 'New Company', subtitle: 'Just the essentials — contacts and leads can link to it.', add: 'Add Company',
      name: 'Name', domain: 'Domain', industry: 'Industry', size: 'Size', location: 'Location', tags: 'Tags',
      tagsPlaceholder: 'enterprise, high-intent',
    },
    contactForm: {
      title: 'New Contact', subtitle: 'Just the essentials — link them to a lead later.', add: 'Add Contact',
      name: 'Name', role: 'Role', company: 'Company', email: 'Email', phone: 'Phone', linkedin: 'LinkedIn',
      searchOrCreate: 'Search or create...',
    },
    leadForm: {
      title: 'New Lead', subtitle: 'Company and contact link up automatically as you type.', add: 'Add Lead', who: 'Who',
